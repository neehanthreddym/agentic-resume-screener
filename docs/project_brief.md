...
|-------|----------------|
| Phase 1–3: Ideation + Research + Architecture | 4h |
| Phase 4: Eval dataset creation + document parsing (PDF + DOCX) | 3h |
| Phase 5: Prompt engineering + LangGraph pipeline | 12h |
| Phase 6: Evaluation | 5h |
| Phase 7: Code quality + tests | 6h |
| Phase 8: FastAPI + Streamlit | 8h |
| Phase 9: Docker + deployment | 5h |
| Phase 10–11: Monitoring + Docs + README | 6h |
| Buffer | 3h |
| **Total** | **52h** |
